...
class Freeseer_gstreamer(BackendInterface):
    ...
    def _set_video_source(self):
        ...
        if (self.video_source_type == 'firewire'):
        ...
        elif ( self.video_source == 'v4l2src' ) :
            ...
            if ( self.icecast ):
                ...
                gst.element_link_many( video_src, self.src_tee, video_rate)
            else:
    ...
    def _clear_video_source(self):
        ...
        if ( self.icecast and self.video_source == 'v4l2src' ):
    ...
    def _set_icecast_streaming(self):
        ...
        icecast_gst_caps = gst.Caps('video/x-raw-rgb,width=320,height=240')
    ...
    def record(self, filename):
        ...
        if ( self.icecast == True and self.video_source == 'v4l2src' ):
